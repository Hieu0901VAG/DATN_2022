...
// void loop() {
//   // Đọc dữ liệu raw từ cảm biến MPU6050
//   mpu6050.update();

//   // Tính giá trị Roll và Pitch từ dữ liệu raw
...
//   // Áp dụng bộ lọc Kalman cho giá trị Roll và Pitch
//   float kalmanRoll = kalmanX.updateEstimate(roll);
//   float kalmanPitch = kalmanY.updateEstimate(pitch);

//   // In ra giá trị sau khi áp dụng bộ lọc Kalman
//   Serial.print("Roll ");
//   Serial.print(roll);
//   Serial.print("  Pitch  ");
//   Serial.print(pitch);
